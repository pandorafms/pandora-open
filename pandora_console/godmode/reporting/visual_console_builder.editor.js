...
// Pandora FMS - http://pandoraopen.io
// ==================================================
...
function setBarsGraph(id_data, values) {
  ...
  jQuery.ajax({
    ...
    success: function(data) {
      $("#" + id_data + " img").attr(
        "src",
        "images/console/signes/barras.png"
      );
  ...
  jQuery.ajax({
    ...
    success: function(data) {
      if (values["clock_animation"] == "analogic_1") {
        $("#" + id_data + " img").attr(
          "src",
          "images/console/signes/clock.png"
        );
      } else {
        $("#" + id_data + " img").attr(
          "src",
          "images/console/signes/digital-clock.png"
        );
      }
        ...
        success: function(data) {
          if (data["no_data"] == true) {
            ...
            if ($("#module_row").css("display") != "none") {
              $("#" + id_data + " img").attr(
                "src",
                "images/console/signes/module_graph.png"
              );
              if (
              ...
              $("#" + id_data + " img").attr(
                "src",
                "images/console/signes/custom_graph.png"
              );
              if (
                $("#text-width_module_graph").val() == 0 ||
                $("#text-height_module_graph").val() == 0
...
function setPercentileBar(id_data, values) {
  ...
  jQuery.ajax({
    ...
    success: function(data) {
      ...
      $("#" + id_data + " img").attr(
        "src",
        "images/console/signes/percentil.png"
      );
...
function setPercentileCircular(id_data, values) {
  ...
  jQuery.ajax({
    ...
    success: function(data) {
      ...
      $("#" + id_data + " img").attr(
        "src",
        "images/console/signes/circular-progress-bar.png"
      );
      if ($("#text-width_percentile").val() == 0) {
        $("#" + id_data + " img").css("width", "130px");
    ...
    success: function(data) {
      if (data["no_data"] == true) {
        if (values["width"] == "0" || values["height"] == "0") {
          $("#" + id_data + " img").attr(
            "src",
            "images/console/signes/module-events.png"
          );
        } else {
          $("#" + id_data + " img").attr(
            "src",
    ...
    success: function(data) {
      if (data["no_data"] == true) {
        if (values["width"] == "0") {
          $("#" + id_data + " img").attr(
            "src",
            "images/console/signes/wrong_donut_graph.png"
          );
        } else {
          $("#" + id_data + " img").attr(
            "src",
        ...
        $("#" + id_data + " img").attr(
          "src",
          "images/console/signes/donut-graph.png"
        );
...
function setPercentileBubble(id_data, values) {
  ...
  jQuery.ajax({
    ...
    success: function(data) {
      ...
      $("#" + id_data + " img").attr(
        "src",
        "images/console/signes/percentil_bubble.png"
      );
...
function showGrid() {
  ...
  if (display == "none") {
    ...
    $("#background_grid").css(
      "background",
      'url("' + 'images/console/background/white_boxed.jpg")'
    );
