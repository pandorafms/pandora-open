...
$data = [];
$data[0] = __('Requests');
$data[1] = html_print_input_text('plugin_pass', $plugin_pass, '', 10, 0, true, false, false, '', $classdisabledBecauseInPolicy);
$data[2] = '';
$data[3] = __('Agent browser id');
$data[4] = html_print_input_text('plugin_user', $plugin_user, '', 30, 0, true, false, false, '', $classdisabledBecauseInPolicy);

push_table_advanced($data, 'web_1');

$data = [];
$data[0] = __('HTTP auth (login)');
$data[1] = html_print_input_text('http_user', $plugin_parameter_http_user, '', 10, 0, true, false, false, '', $classdisabledBecauseInPolicy);
$data[2] = '';
$data[3] = __('HTTP auth (password)');
$data[4] = html_print_input_password('http_pass', $plugin_parameter_http_pass, '', 30, 0, true, false, false, '', $classdisabledBecauseInPolicy);
...
$data[0] = __('Proxy URL');
$data[1] = html_print_input_text('snmp_oid', $snmp_oid, '', 30, 0, true, false, false, '', $classdisabledBecauseInPolicy);
...
$data[1] = html_print_input_text('tcp_send', $tcp_send, '', 30, 0, true, false, false, '', $classdisabledBecauseInPolicy);

$data[2] = '';
$data[3] = __('Proxy auth (pass)');
$data[4] = html_print_input_password('tcp_rcv', $tcp_rcv, '', 30, 0, true, false, false, '', $classdisabledBecauseInPolicy);
...
$data[1] = html_print_input_text('ip_target', $ip_target, '', 30, 100, true, false, false, '', $classdisabledBecauseInPolicy);

$data[2] = '';
$data[3] = __('Proxy auth (realm)');
$data[4] = html_print_input_text('snmp_community', $snmp_community, '', 30, 100, true, false, false, '', $classdisabledBecauseInPolicy);
