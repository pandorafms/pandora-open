...
if ($step == 2) {
    ...
    var options = {
        ...
        allDaySlot: true,
        droppable: false,
        select: select_alert_template,
        selectAllow: selectAllow_alert_template,
        eventAllow: eventAllow_alert_template,
        eventDrop: eventDrop_alert_template,
        eventDragStop: eventDragStop_alert_template,
        eventResize: eventResize_alert_template,
        eventMouseEnter: eventMouseEnter_alert_template,
        eventMouseLeave: eventMouseLeave_alert_template,
        eventClick: eventClick_alert_template,
    };
