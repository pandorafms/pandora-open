-- Pandora OPEN
-- Copyright (c) 2004-2026 Pandora OPEN
-- Please see https://pandoraopen.io/

-- Tested with Mysql/Ubuntu 24 LTS / (march, 2026)
...
CREATE TABLE IF NOT EXISTS `tagente_modulo` (
  ...
  `disabled_by_downtime` TINYINT NOT NULL DEFAULT 0,
  `last_compact` TIMESTAMP NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tcredential_store` (
  ...
  `product` ENUM('CUSTOM', 'WMI', 'SNMP') DEFAULT 'CUSTOM',
  `username` TEXT,
  `password` TEXT,
  `extra_1` TEXT,
  `extra_2` TEXT,
...
CREATE TABLE IF NOT EXISTS `tdiscovery_apps_executions` (
  ...
  `id_app` int(10),
  `execution` text NULL DEFAULT NULL,
