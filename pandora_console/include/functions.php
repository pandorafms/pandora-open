...
function generator_chart_to_pdf(
    ...
    if (!$params['return_img_base_64']) {
        ...
        $img_url  = ui_get_full_url(false).'/attachment/'.$img_file;
    }
...
function chart_generator(
    ...
    $output .= 'var configHomeurl = "'.($config['homeurl']).'";';
    $output .= '</script>';
