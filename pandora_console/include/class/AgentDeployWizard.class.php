...
class AgentDeployWizard
{
    ...
    public function getModalContent()
    {
        ...
        if ($config['language'] === 'es') {
            $instructions_url = 'https://pandoraopen.io/';
        } else {
            $instructions_url = 'https://pandoraopen.io/';
        }
        ...
        if ($config['language'] === 'es') {
            $linux_dependencies_url = 'https://pandoraopen.io/';
        } else {
            $linux_dependencies_url = 'https://pandoraopen.io/';
        }
        ...
        <script type="text/javascript">
            ...
            */
            ...
            function generate_installer() {
                ...
                var win_installer_command = `Invoke-WebRequest -Uri https://firefly.pandorafms.com/pandorafms/latest/Windows/Pandora%20FMS%20Windows%20Agent%20v7.0NG.x86_64.exe -OutFile \$\{env:tmp\}\\\pandora-agent-windows.exe; & \$\{env:tmp\}\\\pandora-agent-windows.exe /S  --ip ${server_addr_val} --group \"${group_val}\"`;
