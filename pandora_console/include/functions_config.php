...
function config_process_config()
{
    ...
    if (!isset($config['custom_title_header'])) {
        config_update_value('custom_title_header', __('Pandora Open'));
    }
    ...
    if (!isset($config['custom_docs_url'])) {
        config_update_value('custom_docs_url', 'https://pandoraopen.io/');
    }

    if (!isset($config['custom_support_url'])) {
        config_update_value('custom_support_url', 'https://support.pandoraopen.io');
    }
