 ...
 */
function modules_get_agentmodule_is_init($id_agentmodule, $id_server=null)
{
 ...
 * module were fired.
 */
function modules_get_agentmodule_status($id_agentmodule=0, $without_alerts=false, $id_server=null)
{
...
function modules_get_modules_name($sql_from, $sql_conditions='')
{
    global $config;
...
/**
 * List all modules in agents selection to node.
 *
 * @param array $agents  Agents ids array.
 * @param array $modules Modules ids array.
 *
