...
function include_javascript_dependencies_flot_graph($return=false, $mobile=false)
{
    ...
    if (!$is_include_javascript) {
        ...
        if ($mobile === true) {
            $output .= '
                <script language="javascript" type="text/javascript" src="'.ui_get_full_url('/mobile/include/javascript/jquery.js').'"></script>
                <script language="javascript" type="text/javascript" src="'.ui_get_full_url('/mobile/include/javascript/jquery.mobile-1.5.0-rc1.js').'"></script>';
        }
        ...
        $output .= '
			<!--[if lte IE 8]><script language="javascript" type="text/javascript" src="'.ui_get_full_url('/include/graphs/flot/excanvas.js').'"></script><![endif]-->
			<script language="javascript" type="text/javascript" src="'.ui_get_full_url('/include/javascript/timezone/src/date.js').'"></script>
			<script language="javascript" type="text/javascript" src="'.ui_get_full_url('/include/graphs/flot/jquery.flot.min.js').'"></script>
			<script language="javascript" type="text/javascript" src="'.ui_get_full_url('/include/graphs/flot/jquery.flot.time.js').'"></script>
			<script language="javascript" type="text/javascript" src="'.ui_get_full_url('/include/graphs/flot/jquery.flot.pie.js').'"></script>
			...
			<script language="javascript" type="text/javascript" src="'.ui_get_full_url('/include/graphs/flot/jquery.flot.threshold.multiple.js').'"></script>
			<script language="javascript" type="text/javascript" src="'.ui_get_full_url('/include/graphs/flot/jquery.flot.symbol.min.js').'"></script>
			<script language="javascript" type="text/javascript" src="'.ui_get_full_url('/include/graphs/flot/jquery.flot.exportdata.pandora.js').'"></script>
			<script language="javascript" type="text/javascript" src="'.ui_get_full_url('/include/graphs/flot/jquery.flot.axislabels.js').'"></script>
			<script language="javascript" type="text/javascript" src="'.ui_get_full_url('/include/graphs/flot/pandora.flot.js').'?v='.$config['current_package'].'"></script>';

        // Chartjs.
        $output .= '<script language="javascript" type="text/javascript" src="'.ui_get_full_url('/include/graphs/chartjs/chart.js').'"></script>';
        $output .= '<script language="javascript" type="text/javascript" src="'.ui_get_full_url('/include/graphs/chartjs/chartjs-plugin-datalabels.min.js').'"></script>';
