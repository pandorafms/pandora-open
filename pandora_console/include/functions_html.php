...
function html_print_select_multiple_modules_filtered(array $data):string
{
    ...
    $output .= html_print_input(
        [
            ...
            'nothing'       => __('All'),
            'nothing_value' => 0,
            'script'        => 'fmModuleChange(\''.$uniqId.'\', 0)',
        ]
    );
    $output .= '</div>';
    ...
    $output .= html_print_input(
        [
            ...
            'return'      => true,
            'onchange'    => 'fmModuleChange(\''.$uniqId.'\', 0)',
        ]
    );
...
function html_print_select_multiple_modules_filtered_formated(array $data):string
{
    ...
    $output .= html_print_input(
        [
            ...
            'nothing'       => __('All'),
            'nothing_value' => 0,
            'script'        => 'fmModuleChange(\''.$uniqId.'\', 0, true)',
        ]
    );
    $output .= '</div>';
    ...
    $output .= html_print_input(
        [
            ...
            'id'          => 'filtered-module-show-common-modules-'.$uniqId,
            'return'      => true,
            'onchange'    => 'fmModuleChange(\''.$uniqId.'\', 0, true)',
        ]
    );
 ...
 * @param boolean $trash     Deprecated argument. Do not use.
...
function html_print_header_logo_image(bool $menuCollapsed, bool $return=false)
{
    ...
    if ($config['style'] === 'pandora_black') {
        ...
        $custom_logo_collapsed = 'images/custom_logo/'.HEADER_LOGO_BLACK_COLLAPSED;
