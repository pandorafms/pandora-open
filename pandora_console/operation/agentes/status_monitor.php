...
if (empty($result) === false) {
    ...
    if (in_array('data_type', $show_fields) ) {
    ...
    if (in_array('module_name', $show_fields) ) {
    ...
    if (in_array('server_type', $show_fields) ) {
    ...
    if (in_array('interval', $show_fields) ) {
    ...
    foreach ($result as $row) {
        ...
        if (in_array('module_name', $show_fields) === true) {
        ...
        if (in_array('server_type', $show_fields) === true) {
            $data[4] = ui_print_servertype_icon((int) $row['id_modulo']);
        }


        if (in_array('interval', $show_fields) === true) {
