...
class EventsHistoryTest extends TestCase
{
    ...
    public function testContainerIsRepresentedAsJson(): void
    {
        ...
        $this->assertEquals(
            '{"aclGroupId":null,"agentId":null,"agentName":null,"encodedHtml":"PGgxPkZvbzwvaDE+","height":0,"id":7,"isLinkEnabled":true,"isOnTop":false,"label":null,"labelPosition":"up","linkedLayoutAgentId":3,"linkedLayoutId":2,"linkedLayoutStatusType":"default","maxTime":12800,"moduleId":null,"moduleName":null,"parentId":null,"type":14,"width":0,"x":-666,"y":76}',
            (string) EventsHistory::fromArray(
                [
                    'id'                    => 7,
                    'type'                  => AUTO_SLA_GRAPH,
        ...
        $this->assertEquals(
            '{"aclGroupId":null,"agentId":21,"agentName":null,"encodedHtml":"PGgxPkZvbzwvaDE+","height":0,"id":7,"isLinkEnabled":true,"isOnTop":false,"label":null,"labelPosition":"up","linkedLayoutAgentId":15,"linkedLayoutId":3,"linkedLayoutStatusType":"default","maxTime":12800,"moduleId":385,"moduleName":"module_test","parentId":null,"type":14,"width":0,"x":-666,"y":76}',
            (string) EventsHistory::fromArray(
                [
                    'id'                    => 7,
                    'type'                  => AUTO_SLA_GRAPH,
