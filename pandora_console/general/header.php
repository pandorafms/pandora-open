...
?>
    <div id="header_table_inner">
        ...
        if ($check_minor_release_available === true) {
            if (users_is_admin($config['id_user'])) {
                if ($config['language'] === 'es') {
                    set_pandora_error_for_header('Hay una o mas revisiones menores en espera para ser actualizadas. <a id="aviable_updates" target="blank" href="https://pandora-open.io/">Sobre actualización de revisión menor</a>', 'Revisión/es menor/es disponible/s');
                } else {
                    set_pandora_error_for_header('There are one or more minor releases waiting for update. <a id="aviable_updates" target="blank" href="https://pandora-open.io/">About minor release update</a>', 'minor release/s available');
                }
            }
        }
        ...
        <div id="msg-header" class="invisible"></div>
            <a href="https://github.com/pandorafms/pandora-open/wiki" target="_blank">'.__('Pandora OPEN documentation').'</a>';

        $modal_box .= '<hr class="separator" />';
        $modal_box .= '<a href="https://github.com/pandorafms/pandora-open/issues" target="_blank">'.__('Open an issue in Github').'</a>';
        ...
        $subtitle_header = __('the Open Monitoring System');
                ...
                onload: () => {
                    $(document).ready(function () {
                        ...
                        <div class="welcome-wizard-buttons">
                            ...
                            <button class="secondary buttonButton close-wizard-button"><?php echo __('Close wizard'); ?></button>
                        </div>
                        `);
