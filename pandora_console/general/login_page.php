...
echo '<div class="login_page">';
    ...
    $theme_logo = ($config['style'] === 'pandora') ? 'images/custom_logo_login/Pandora-FMS-alt-black.png' : 'images/custom_logo_login/Pandora-FMS-1.png';
...
html_print_csrf_hidden();
    ...
    echo '</form></div>';
    echo '<div class="login_data_wrapper"><div class="login_data">';

echo '<div class ="text_banner_login">';
echo '<div class="center"><span class="banner-text banner-text-sm">';
echo 'Open Source. Open Minds.';


echo '</span></div>';

echo '<div class ="text_banner_login">';
echo '<div class="center"><span class="banner-text banner-text-bg">';
echo 'Open Monitoring';


echo '</span></div>';
echo '<div></div><span class="span2">';
echo '</span></div>';
echo '</div>';
echo '</div>';
echo '</div>';
    ...
    echo '<div id="reset_correct" title="'.__('Password reset').'">';
        echo '<div class="content_alert">';
            echo '<div class="icon_message_alert">';
                echo html_print_image('images/custom_logo/logo-default-pandorafms-collapsed.svg', true, ['alt' => __('Password reset'), 'border' => 0]);
            echo '</div>';
        ...
        echo '<div class="content_alert">';
            echo '<div class="icon_message_alert">';
                if ($config['style'] === 'pandora_black') {
                    echo html_print_image('images/custom_logo/logo-black-pandorafms-collapsed.svg', true, ['alt' => __('Logged out'), 'border' => 0]);
                } else {
                    echo html_print_image('images/custom_logo/logo-default-pandorafms-collapsed.svg', true, ['alt' => __('Logged out'), 'border' => 0]);
                }
            echo '</div>';
            echo '<div class="content_message_alert">';
                echo '<div class="text_message_alert">';
