...
namespace Pandora_Modules {
	...
	public:
		...
		virtual void setOutput     (string output, string metadata);
		virtual void setOutput     (string output, SYSTEMTIME *system_time);
		virtual void setOutput     (string output, string metadata, SYSTEMTIME *system_time);
		...
		bool        isIntensive ();
		void        setSourceType (string source_type);
