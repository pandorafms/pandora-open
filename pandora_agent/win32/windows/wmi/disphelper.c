...
#define SetStackCount(nStackCount)   TlsSetValue(f_TlsIdxStackCount, (LPVOID)(ULONG_PTR)(nStackCount))
#define SetExceptionPtr(pException)  TlsSetValue(f_TlsIdxException, pException);
#define GetStackCount()       (UINT)(ULONG_PTR) TlsGetValue(f_TlsIdxStackCount)
