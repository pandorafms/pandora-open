...
## Understanding what is a Pandora Open Agent

Pandora Open agents collect all system's data. They are executed in each local
...
## Pandora Open Agent configuration
...
## Installing Pandora Open Agent for unix
...
--install
    ...
    Pandora Open Agent Installer 1.0 (c) 2021 Sancho Lerena
    This program is licensed under GPL2 Terms. http://pandora.sourceforge.net

    Checking default dir /usr/share/pandora_agent...
    Checking Pandora Open Agent on /usr/bin/pandora_agent....
    Creating Pandora Open Agent home directory at /usr/share/pandora_agent ...
    .
    .
    
    Creating logfile at /var/log/pandora_agent.log...
    Copying Pandora Open Agent to /usr/bin/pandora_agent...
    ...
    under /home/pandora/.ssh/authorized_keys on your Pandora Open Server host
    You also need to setup your /etc/pandora/pandora_agent.conf config file

### Run your Pandora Open unix agent

First to need to create your agent in your Pandora Open console as described in
...
If you have problems, a good idea is restart Pandora Open agent manually to check
errors in startup:
