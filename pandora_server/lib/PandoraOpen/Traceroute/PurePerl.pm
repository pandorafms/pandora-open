# Repackaged by Pandora Open
# Original lib at Net::Traceroute::PurePerl;

package PandoraOpen::Traceroute::PurePerl;

use vars qw(@ISA $VERSION $AUTOLOAD %net_traceroute_native_var %protocols);
use strict;
use warnings;
use PandoraOpen::Traceroute;
use Socket;
use FileHandle;
use Carp qw(carp croak);
use Time::HiRes qw(time);

@ISA = qw(PandoraOpen::Traceroute);
$VERSION = '0.10';
...
sub traceroute 
{
   ...
   carp "No host provided!" && return unless (defined $self->host);
