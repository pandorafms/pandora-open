...
# and performance in order to help Pandora Open team to solve problems you may have.
...
echo " "
echo "Pandora Open Diagnostic Script v1.0 (c) ArticaST 2009-2015"
...
echo "-----------------------------------------------------------------" >> $OUTFILE
echo "Pandora Open Server Configuration file" >> $OUTFILE
echo "-----------------------------------------------------------------" >> $OUTFILE
cat /etc/pandora/pandora_server.conf | grep -v "pass" >> $OUTFILE

echo "-----------------------------------------------------------------" >> $OUTFILE
echo "Pandora Open Logfiles information" >> $OUTFILE
echo "-----------------------------------------------------------------" >> $OUTFILE
