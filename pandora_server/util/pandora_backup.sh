...
# Pandora Open Command line Backup Tool
# (c) Sancho Lerena <slerena@gmail.com>, Pandora Open 2009-2023

function help {
	echo ""
	echo -e "Pandora Open Command line backup tool. http://www.pandorafms.org" 
	echo -e "(c) 2009-2015 Sancho Lerena <slerena@gmail.com>, Pandora Open"
	echo ""
	echo -e "Syntax:" 
	echo -e "\t\t-c Path to Pandora Open console, p.e: /srv/www/htdocs/pandora_console"
	...
	echo -e "PandoraOpen install, including files, configuration and data. Please backup first!"
	echo ""
	exit 1
}
...
# Make the backup restore process
	...
	echo "Detected Pandora Open backup at $SOURCEBACKUP, please wait..."
