...
##################################################################################
# Inventory Change detector Plugin for Pandora Open 3.0
...
sub help {
	print "\nPandora Open Inventory Change detector for Pandora Open\n\n";
	print "Syntax: \n\n\t ./pandora_inventory_change.pl [-c /etc/pandora/pandora_server.conf] -a agent_name -m module_name [ -q ] \n\n";

	print "\t -c It's optional, by default read Pandora Open config file at /etc/pandora\n\n";
