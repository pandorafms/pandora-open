...
Example: $0 -host "192.168.80.43" -user "pandora/Administrator" -pass "PandoraOpen1234" -wmiClass "Win32_OperatingSystem" -fieldsList "TotalVisibleMemorySize,FreePhysicalMemory" -operation "((_f1_ - _f2_) * 100) / _f1_"
