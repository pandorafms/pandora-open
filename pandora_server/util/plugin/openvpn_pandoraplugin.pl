#!/usr/bin/perl
##################################################################################
# OpenVPN Plugin for Pandora Open 2.0
# (c) Sancho Lerena 2008, slerena@gmail.com
# This is the first plugin for Pandora Open 2.0 plugin server
#
...
# ------------------------------------------------------------------------------------------
sub help {
    print "OpenVPN Plugin for Pandora Open 2.0, (c) Sancho Lerena 2008 \n";
    print "Syntax: \n\n";
    print "\t -a <host>\n\t -w <pass>\n\t -p <port>\n\t -t <timeout>\n\t -q\n";
    print "\n";
}
