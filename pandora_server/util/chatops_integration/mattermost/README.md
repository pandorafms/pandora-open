# Pandora Open Mattermost Plugin

A plugin for [Pandora Open](https://github.com/pandorafms/pandorafms) to enable notifications to Mattermost Open Source Chat.

# Usage

Assuming you are using Pandora Open 6.0, the steps are:

1. Create the [Alert command](https://pandoraopen.io/) going to Alerts -> Commands and clicking on "Create". Then:
   ![create command](help/images/1-set-up-the-mattermost-command.png?raw=true "Set up Mattermost Command")

2. Define the [Alert Action](https://pandoraopen.io/) going to Alerts -> Actions and clicking on "Create". Then:
