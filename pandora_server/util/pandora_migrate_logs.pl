#!/usr/bin/perl
#
# Pandora Open log migration tool
#
# Pandora Open 2017-2023
...
Pandora Open log migration tool (c) Pandora Open
...
pandora_init(\%pa_config, 'Pandora Open log migration tool');
