...
# Pandora Open group where agents will be placed.
my $GROUP_ID;
...
sub arp_cache_discovery {
	...
	# Create a Pandora Open agent for the device.
...
##########################################################################
sub show_help {
	print "\nPandora Open SNMP Recon Plugin for level 2 network topology discovery.\n";
	print "(c) Pandora Open 2014-2023 <info\@pandorafms.com>\n\n";
	print "Usage:\n\n";
	...
	print " parameters are automatically filled by the Pandora Open Server.\n";
	exit;
}
