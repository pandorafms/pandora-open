...
# Pandora Open configuration hash.
my $OSNAME = $^O;
my %CONF;
...
# If set to 1 incidents will be created in the Pandora Open Console.
my $CREATE_INCIDENT;
...
sub show_help {
	...
	print "\n The other parameters are automatically filled by the Pandora Open Server.\n\n\n";
	exit;
}
...
##########################################################################
# Create a Pandora Open agent for the given address if it does not exist.
##########################################################################
